...
ActiveRecord::Schema.define(version: 2022_08_08_000846) do
  ...
  create_table "decidim_proposals_proposals", id: :serial, force: :cascade do |t|
    ...
    t.integer "comments_count", default: 0, null: false
    t.integer "follows_count", default: 0, null: false
    t.integer "proposal_no_login_votes_count", default: 0, null: false
  ...
  create_table "decidim_users", id: :serial, force: :cascade do |t|
    ...
    t.string "zipcode", default: "123-4567", null: false
    t.integer "birth_year", default: 1, null: false
    t.string "real_name", default: "default real name", null: false
    t.datetime "accepted_privacy_policy_version"
