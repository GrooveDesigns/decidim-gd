...
Decidim.configure do |config|
  ...
  config.application_name = "Decidim Gd"

  # The email that will be used as sender in all emails from Decidim
  config.mailer_sender = ENV.fetch('MAILER_SENDER') { 'test@mail.com' }
...
Decidim.content_blocks.register(:homepage, :navigation_phase) do |content_block|
  content_block.cell               = 'decidim/content_blocks/navigation_phase'
  content_block.public_name_key    = "decidim.content_blocks.navigation_phase.name"
end

Decidim.content_blocks.register(:homepage, :html_block2) do |content_block|
