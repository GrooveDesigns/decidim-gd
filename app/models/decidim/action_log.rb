...
module Decidim
  ...
  class ActionLog < ApplicationRecord
    ...
    def visible_for?(user)
      ...
      # 関連付けられているリソースごとに、上述までの条件以外で任意の条件で可視性をコントロールできる invisible_action_log?というメソッドを期待するようにした
      return false if resource_lazy.respond_to?(:invisible_action_log?) && resource_lazy.invisible_action_log?
