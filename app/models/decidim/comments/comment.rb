...
module Decidim
  module Comments
    ...
    class Comment < ApplicationRecord
      ...
      # ActionLogの可視性をコントロールするメソッド
      # コメント元のリソースのinvisible_action_log?の値を参照するようにしている
      def invisible_action_log?
        return true if root_commentable.respond_to?(:invisible_action_log?) && root_commentable.invisible_action_log?
